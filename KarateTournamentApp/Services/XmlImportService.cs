...
namespace KarateTournamentApp.Services
{
    ...
    {
        /// <summary>
        /// Asynchronously imports participants from XML file
        /// XML format: 
        /// <Participants>
        ///   <Participant>
        ...
        /// </Participants>
        /// </summary>
        public async Task<List<Participant>> ImportParticipantsFromXmlAsync(string filePath)
        {
        ...
        /// <summary>
        /// Asynchronously creates sample XML file
        /// </summary>
        public async Task CreateSampleXmlFileAsync(string filePath)
        {
            await Task.Run(() =>
            {
